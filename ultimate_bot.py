...
def write_script(story_data, language_cfg, genre_key, conn, format_mode):
    ...
    system_prompt = (
        ...
        "STORY SHAPE:\n"
        "- Preserve every distinct narrative beat as its own scene. Do not collapse a developed story into a one-, two- or three-scene summary, and do not create scenes whose only purpose is padding.\n"
        ...
        "Return ONLY valid JSON. Use as many scenes as the story genuinely needs. "
        "Do not mention scene limits or word limits in the output.\n"
        "{\n"
        "  \"step_1_headline\": \"...\",\n"
        "  \"step_2_data_points\": \"...\",\n"
        "  \"step_3_critique\": \"...\",\n"
