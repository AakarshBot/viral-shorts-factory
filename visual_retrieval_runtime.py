...
SOFT_MIN_IMAGE_SIDE = max(240, min(900, int(os.getenv("VISUAL_SOFT_MIN_IMAGE_SIDE", "540"))))
        ...
        output.append(
            {
                ...
                "source_page_url": str(asset.get("source_page_url") or asset.get("page_url") or "").strip(),
                "source_image_url": str(asset.get("source_image_url") or asset.get("image_url") or "").strip(),
...
def collect_manual_visual_options(
    ...
    result["minimum_options"] = max(0, min(int(min_options or 0), maximum))
