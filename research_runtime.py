...
def _fallback_prompt(language_cfg: Dict[str, Any], format_mode: str, story_data: Dict[str, Any] | None = None) -> str:
    ...
    return (
        ...
        "Preserve distinct hook, development, context and consequence beats, but for a compact 20–30 second story "
        "you may combine one middle beat into a single scene when that protects pacing; never add filler solely "
        "to satisfy a scene count. Let the story determine the number of scenes. "
