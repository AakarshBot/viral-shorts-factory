...
from thumbnail_runtime import install as install_thumbnail_disable
from visual_query_lock_runtime import install as install_visual_query_lock
...
def _init_runtime() -> None:
    ...
    install_thumbnail_disable()
    install_visual_query_lock()
